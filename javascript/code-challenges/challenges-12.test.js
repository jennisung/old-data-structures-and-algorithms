...
const replaceZeros = (string) => {
  // Solution code here...
  let replaceStr = string.replace(/0/g, 'zero');
  return replaceStr;
};
...
const validateWord = (word) => {
  // Solution code here...
  let nums = /^\b[a-zA-Z]{5,10}\b$/;
  return nums.test(word);
};
...
const validateEmail = (email) => {
  // Solution code here...
  let nums = /^[a-zA-Z0-9]+(\.[a-zA-Z0-9]+)?@[a-zA-Z0-9]+\.(com|net|org)$/;
  return nums.test(email);
};
