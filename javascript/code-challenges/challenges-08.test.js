...
const containsWorld = (input) => {
  // Solution code here...
  let matchWorld = /\bworld\b/;
  return matchWorld.test(input);
};
...
const isCapitalized = (str) => {
  // Solution code here...
  let matchCapitalized = /\b[A-Z][a-zA-Z]*\b/g;
  let findMatched = str.match(matchCapitalized);
  return findMatched || [];
};
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  let matchAJ = /^[A-J]/i;
  return arr.filter((cities) => matchAJ.test(cities));
};
